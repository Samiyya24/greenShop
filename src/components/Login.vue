...
<template>
	<div
		@click="closeModal"
		class="fixed top-0 left-0 z-30 w-full h-screen bg-black/40"></div>
	<div
		...
		<div class="mb-3 text-center divide-x md:mb-10">
			<button
				@click="content = 'login'"
		...
		<div v-if="content == 'login'">
			...
			<form action="/" class="relative flex flex-col mb-12">
				<input
      ...
      >
        ...
        />
			...
			<div class="flex items-center gap-3 text-[#3D3D3D] justify-center mb-10">
				<div class="border w-28"></div>
				<span class="text-sm">Or login with</span>
				<div class="border w-28"></div>
			</div>
			<div class="flex flex-col justify-center">
				<button class="flex items-center gap-3 px-20 py-3 mb-5 border px-full">
					<svg
						width="20"
						height="20"
						viewBox="0 0 20 20"
				...
				<button class="flex items-center gap-3 px-20 py-3 border px-full">
					<svg
						width="20"
						height="20"
						viewBox="0 0 20 20"
