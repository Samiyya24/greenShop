<template>
  <div
    :class="show ? 'close' : ''"
    @click="toggle"
    class="bg-black/40 fixed top-0 left-0 w-full h-screen z-10 hidden"
  ></div>
  <div
    class="fixed top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2 bg-white border-b-8 border-b-[#46A358] py-10 px-28 hidden"
  >
    ...
    <div class="divide-x text-center mb-10">
      <a class="px-5 text-xl font-medium hover:text-[#46A358]" href="#login"
        >Login</a
      >
      <a class="px-5 text-xl font-medium hover:text-[#46A358]" href="#register"
        >Register</a
      >
    </div>
    ...
    <form action="/" class="flex flex-col relative mb-12">
      ...
      <!-- </div> -->
      <a class="text-sm text-[#46A358] text-end mb-7" href="#"
        >Forgot Password?</a
      >
      <button
        class="bg-[#46A358] text-white text-base font-bold py-4 rounded-lg"
      >
        Login
      </button>
    </form>
    <div class="flex items-center gap-3 text-[#3D3D3D] justify-center mb-10">
      <div class="w-28 border"></div>
      <span class="text-sm">Or login with</span>
      <div class="w-28 border"></div>
    </div>
    <div class="flex flex-col justify-center">
      <button class="border py-3 px-20 px-full flex items-center gap-3 mb-5">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
      ...
      <button class="border py-3 px-20 px-full flex items-center gap-3">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
