...
<template>
	<header class="sticky top-0 left-0 z-20 w-full">
		<div class="container mx-auto">
			<nav
				class="z-30 flex items-center justify-between py-5 bg-white border-b">
				...
				<ul class="items-start hidden gap-12 md:flex">
					<li>
						<a
							href="#home"
