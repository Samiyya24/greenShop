...
<template>
  <div
    ...
    class="z-10 items-center max-w-sm px-10 text-left md:bg-slate-100/70 bg-slate-100 max-md:py-2 max-md:fixed top-20 min-h-screen"
  >
    <div class="py-3">
    ...
    <div class="mb-6">
      <h1 class="mb-5 text-lg font-bold">Price Range</h1>
      <input
        id="small-range"
        type="range"
        value="50"
        class="h-1 mb-6 bg-gray-200 rounded-lg appearance-none cursor-pointer range-sm dark:bg-gray-200"
      />
      <p class="mb-5">
    ...
    >
      ...
      <p class="font-bold group-hover:text-[#46A358]">({{ size.count }})</p>
    </div>
